                                        ...
                                        <div class="tg-postcontent">
                                            <fieldset class="fieldset form-group">
                                                ...
                                                <div class="tg-posttitle">
                                                    ...
                                                    <h3 class="mb-3">
                                                        @php
                                                        $borrowDate = new DateTime(date("Y-m-d",$requestHistory[0]->transaction_datetime));
                                                        $today = new DateTime();
                                                        $totalDaysDiff = $borrowDate->diff($today)->days;
                                                        @endphp
                                                        <span class="label-font label-width">
                                                            Total days
                                                        </span>
                                                    ...
                                                    <h3 class="mb-3">
                                                        ...
                                                        $today = new DateTime();
                                                        if($returnDate<$today){
                                                            $totalDelay = $returnDate->diff($today)->days;
                                                        }else{
                                                            $totalDelay = 0;
                                                        }
                                                        @endphp
                                                    ...
                                                    <h3 class="mb-3">
                                                        ...
                                                        <a href="javascript:void(0);">{{($requestHistory[0]->penalty_waived_off)?0:($totalDelay*$book->penalty_per_day)}}</a>
                                                    </h3>
                                                    <!-- <h3 class="mb-3">
                                                        <span class="label-font label-width">
                                                            Penalty reason
    ...
    $(document).ready(function() {
        ...
        $("#submit").click(function() {
            ...
            $.ajax({
                ...
                data:{actionType:'return', request_id:"{{$requestDetails->id}}", notes:notes},
