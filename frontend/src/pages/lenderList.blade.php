                    ...
                    <div id="tg-content" class="tg-content content-area">
                        <div class="tg-newsdetail">
                            ...
                            <div class="dash-content panel panel-default">
                                <a href="{{ route('lenderRequestDetails',['id'=>$row->id]) }}">
                                ...
                                <div class="btn-container">
                                    ...
                                    <a href="{{ url('chat').'/'.$row->borrower_id.'/'.$row->id }}" class="btn btn-primary text-uppercase">
                                        Chat
                                    </a>
                                    @endif
                                    {{-- @if(trim($row->status)=='Requested')
                                    <a href="{{ route('lender.approvedRequestIndex',['request_id'=>$row->id]) }}" class="btn btn-secondary">
                                    Approve Lending
                                    </a>
                                    @endif
                                    @if(trim($row->status)=='Returning')
                                    <a href="{{ route('lender.approvedReturnIndex',['request_id'=>$row->id]) }}" class="btn btn-secondary">
                                        Approve Return
                                    </a>
                                    @endif --}}
                                </div>
